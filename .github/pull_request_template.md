...
Docs/config only:
docs, policies, CI/workflow, scripts, repo config. No app behavior/spec change.

Product code or spec changes:
`src/**`, behavior-affecting tests, `docs/dev/Specification.md`, `Spec` attributes.
